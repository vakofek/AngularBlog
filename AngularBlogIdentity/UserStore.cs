...
using AngularBlogRepository;
using Microsoft.AspNetCore.Identity;
using System;
using System.Threading;
using System.Threading.Tasks;

namespace AngularBlogIdentity
{
        ...
        IUserPasswordStore<ApplicationUserIdentity>
    {
        ...
        private readonly IAccountRepository _accountRepositor;

        public UserStore(IAccountRepository accountRepository)
        {
            _accountRepositor = accountRepository;
        }


        public async Task<IdentityResult> CreateAsync(ApplicationUserIdentity user, CancellationToken cancellationToken)
        {
            return await _accountRepositor.CreateAsync(user, cancellationToken);
        }

        public async  Task<ApplicationUserIdentity> FindByNameAsync(string normalizedUserName, CancellationToken cancellationToken)
        {
            return await _accountRepositor.GetByUsernameAsync(normalizedUserName, cancellationToken);
        }
